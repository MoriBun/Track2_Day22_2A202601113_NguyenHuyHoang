...
PROMPT_V1_NAME = "nguyen-huy-hoang-rag-prompt-v1"
PROMPT_V2_NAME = "nguyen-huy-hoang-rag-prompt-v2"
...
SYSTEM_V1 = (
    ...
    "câu hỏi. Trả lời ngắn gọn, rõ ràng trong 2-4 câu. Nếu context không có "
    "thông tin, hãy nói thẳng là không biết.\n\nContext:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích AI. Chỉ dùng context sau để trả lời. "
    "Trình bày có cấu trúc trong 3-5 câu: nêu kết luận chính, giải thích facts liên quan, "
    "và nói rõ khi context chưa đủ cơ sở. Không suy đoán thêm.\n\nContext:\n{context}"
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1: tra loi ngan gon, than thien",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2: phan tich co cau truc",
        )
